...
const QuestionRequisition = () => {
  ...
  const addNewSchool = async () => {
    await firestore()
      .collection('questions')
      .where('udise', '==', addInputField.udise)
      .get()
      .then(async snapShot => {
                  ...
                  {showData && (
                    <View>
                      <View style={styles.itemView}>
                        ...
                        {enteryDone ? (
                          <Text selectable style={[styles.dropDownText,{color:"red"}]}>
                            Entry Done
                          </Text>
                        ) : (
                          <Text selectable style={[styles.dropDownText,{color:"green"}]}>
                            Entry Not Done
                          </Text>
                        )}
                      </View>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    showToast(
                      'success',
                      'Your submission token has been copied successfully',
                    );
                  }}>
                  {copied ? (
                    <Text
